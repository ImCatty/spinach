...
public class ExcelUtil {
    ...
    public static void main(String[] args) {
        ...
        String path = "C:\\Users\\car\\Desktop\\spinach\\500万数据采集全\\半全场\\J2联赛半全场数据采集(1).xlsx";
////                "D:\\IDE\\workspace-Neon\\Java\\src\\refund.xls";
...
//        System.out.println("End: "  + System.currentTimeMillis());
        System.out.println("Coast:" +  (e-s));
    	
//    	String path = "C:\\Users\\car\\Desktop\\spinach\\500万数据采集全\\半全场";
//    	ExcelUtil util = new ExcelUtil();
    	
    }
    
//    public List<List<String>> getLocalDate(String path) {
//    	
////    	Object ob = getPath(path);
////    	if(ob instanceof String) {		
//    	
//            try {
//            	 List<List<String>> result = readXlsx(path);
//            	 return result;
////            	 System.out.println(result.size());
////	            for (int i = 0; i < result.size(); i++) {
////	                List<String> model = result.get(i);
...
//    }
    ...
    * @throws
    */
   public List<List<String>> readXlsxForTitel(String path) throws Exception {
       InputStream is = new FileInputStream(path);
       XSSFWorkbook xssfWorkbook = new XSSFWorkbook(is);
       List<List<String>> result = new ArrayList<List<String>>();
       // 循环每一页，并处理当前循环页

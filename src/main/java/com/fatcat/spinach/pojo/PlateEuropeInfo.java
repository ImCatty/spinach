...
@Table(name = "plate_europe_info")
@Component
public class PlateEuropeInfo {
    @Id
    private Integer id;
     ...
     * 欧赔ID
     */
    @Column(name = "plante_europe_id")
    private String planteEuropeId;
     ...
     * 获取欧赔ID
     *
     * @return plante_europe_id - 欧赔ID
     */
    public String getPlanteEuropeId() {
        return planteEuropeId;
    }

    /**
     * 设置欧赔ID
     *
     * @param planteEuropeId 欧赔ID
     */
    public void setPlanteEuropeId(String planteEuropeId) {
        this.planteEuropeId = planteEuropeId;
    }
